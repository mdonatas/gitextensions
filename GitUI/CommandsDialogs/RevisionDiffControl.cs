...
namespace GitUI.CommandsDialogs
{
    public partial class RevisionDiffControl : GitModuleControl
    {
        ...
        public void DisplayDiffTab()
        {
            ...
            {
                DiffFiles.SetSelectedItem(_oldDiffItem);
                _oldDiffItem = null;
                _oldRevision = null;
            }
        }
        ...
        private async Task ShowSelectedFileDiffAsync()
        {
            ...
            await DiffText.ViewChangesAsync(parentRevision?.ObjectId, revision.ObjectId, selectedItem, string.Empty,
        ...
        private void openWithDifftoolToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                if (fileStatusItem.ParentRevision.Guid == GitRevision.CombinedDiffGuid)
                {
